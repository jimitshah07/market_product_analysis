================================================================================ MARKET RESEARCH PRO — ULTIMATE EDITION README & SETUP DOCUMENTATION
OVERVIEW
Market Research Pro is a high-end, AI-powered desktop application designed for entrepreneurs in India to perform professional-grade market intelligence. It features specialized modes for General Market Research and Deep Restaurant Competitor Analysis, integrating data from Google Maps, Amazon.in, Play Store, and Google Trends with a local AI brain (Ollama).
...
KEY FEATURES & MODES
🍽️ RESTAURANT INTELLIGENCE MODE
...
AI Vision Media Categorization: Automatically sorts photos into Food, Menu, and Ambiance buckets using local Vision models (qwen2.5-vl/llava).
...
Multilingual Sentiment Analysis: Supports English, Hindi, Gujarati, and 8+ regional languages.
REQUIRED DEPENDENCIES
Core Installation: pip install requests python-dotenv beautifulsoup4 matplotlib numpy Pillow

Feature Unlock (Recommended): pip install textblob google-play-scraper pytrends reportlab serpapi deep-translator langdetect
...
Start: ollama serve
CONFIGURATION (.env)
Create a .env file: SERPAPI_KEY=your_key_here OLLAMA_MODEL=qwen2.5:1.5b OLLAMA_VISION_MODEL=qwen2.5-vl OLLAMA_URL=http://localhost:11434
...
Performance: All AI processing is local; high RAM is recommended for Ollama Vision features.
